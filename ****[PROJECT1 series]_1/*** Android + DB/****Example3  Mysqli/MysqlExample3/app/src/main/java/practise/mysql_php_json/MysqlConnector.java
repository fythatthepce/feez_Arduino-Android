...
public class MysqlConnector {
    ...
    public static ArrayList<HashMap<String, String>> selectAllUser() { //------------ Method to select data ---------------//
        ...
        try {
			...
			/* Set URL*/
            HttpPost httppost = new HttpPost("http://urbanstreet101.ddns.net:8080/showdata2.php"); // https://10.0.2.2/
			/* End Set URL*/
        ...
        try {
            ...
            for (int i = 0; i < jArray.length(); i++) {
                ...
                user.put("password", jo.get("password").toString());
                user.put("email", jo.get("email").toString());
