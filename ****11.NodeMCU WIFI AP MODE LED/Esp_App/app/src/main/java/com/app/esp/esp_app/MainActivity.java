...
public class MainActivity extends AppCompatActivity {
    ...
    public static String networkSSID="FEEz_NodeMCU";
    public static String networkPass="fee123456";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnCon = (Button)findViewById(R.id.button_con);
        btnDis = (Button)findViewById(R.id.button_dis);
        btnPress = (Button)findViewById(R.id.button_press);
    ...
    private void led_on(){
        ...
        buf=null;
        buf=("9").getBytes(); // value to be send to esp
    ...
    public void led_1(View v){  //inclick LED1
